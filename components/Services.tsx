      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {servicesList.map((service) => (
            <div key={service.id} className="group relative h-[400px] rounded-2xl overflow-hidden border border-white/5 bg-surface hover:border-primary/50 transition-all duration-500">
              {/* Image Background */}
              <div
